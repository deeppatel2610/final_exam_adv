        ...
        () => ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return Card(
              child: ListTile(
                title: Text(
                  dbHelperController.contactDbList[index].name.toString(),
                ),
                subtitle: Text(
                  dbHelperController.contactDbList[index].email.toString(),
                ),
                trailing: Row(
                    ...
                    IconButton(
                      onPressed: () {
                        dbHelperController.deleteDatabase(
                          id: dbHelperController.contactDbList[index].id!,
                        );
                      },
